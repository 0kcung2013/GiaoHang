abstract final class OrderDetailStrings {
  ...
  static const keepOrderAction = 'Giữ đơn hàng';
  static const continueCancelAction = 'Vẫn hủy đơn';
  static const cancelConfirmTitle = 'Xác nhận hủy đơn';
  static const cancelAssignedWarning =
      'Tài xế đang trên đường đến điểm lấy hàng. Bạn có chắc chắn muốn hủy đơn không?';
  static const cancelPickingUpWarning =
      'Tài xế đang ở điểm lấy hàng. Hủy lúc này có thể gây bất tiện. Bạn có chắc chắn muốn tiếp tục?';
