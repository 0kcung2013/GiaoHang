abstract final class SupportTicketStrings {
  ...
  static const retryHint = 'Kiểm tra kết nối và quyền truy cập rồi thử lại.';
  static const emptyTitle = 'Chưa có yêu cầu hỗ trợ';
  static const emptySubtitle = 'Yêu cầu mới sẽ xuất hiện tại đây.';
