...
Future<bool?> showDriverRateCustomerSheet({
  ...
  return showModalBottomSheet<bool>(
    ...
    builder: (_) =>
        _DriverRateCustomerSheet(order: order, customerName: customerName),
  );
}

class _DriverRateCustomerSheet extends ConsumerStatefulWidget {
  const _DriverRateCustomerSheet({required this.order, this.customerName});
