...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  static const _pages = [
    ...
    _OnboardingPageData(
      ...
      description:
          'Hệ thống tự động tìm tài xế gần bạn để giao hàng nhanh nhất',
      emoji: '🚚',
    ),
    _OnboardingPageData(
...
class _BackgroundPainter extends CustomPainter {
  ...
  _BackgroundPainter({required this.currentPage, required this.tick});
  ...
  bool shouldRepaint(_BackgroundPainter oldDelegate) =>
      oldDelegate.currentPage != currentPage || oldDelegate.tick != tick;
}
